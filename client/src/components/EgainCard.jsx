        ...
        <div class="md:w-1/3 p-4">
          ...
          <div class="bg-gray-100 border-r-2 border-gray-300 p-4">
            <p class="text-gray-700">
              ...
              offers endless sales and service opportunities when combined with
              companion products, eGain Cobrowse™, a web collaboration solution,
              eGain Offers™, a proactive offer management solution, and eGain
              Virtual Assistant™, a virtual assistant (avatar) solution. eGain’s
              chat and web collaboration solutions lead the industry in
              maturity, depth, and seamless integration with other interaction
              channels.
            </p>
          </div>
        </div>
        <div class="md:w-1/3 p-4">
          ...
          <div class="bg-gray-100 border-r-2 border-gray-300 p-4">
            <p class="text-gray-700">
              ...
              one of the many innovative customer interaction products in eGain,
              ...
              <ul className="text-dark list-disc">
                ...
                <li>
                  {" "}
                  Monitor and track every call Integrate multichannel customer
                  communications
                </li>
              </ul>
            </p>
        ...
        <div class="md:w-1/3 p-4">
          ...
          <div class="bg-gray-100  border-gray-300  p-4">
            <p class="text-gray-700">
              ...
              simply chats with the virtual assistant (also called virtual agent
              or chatbot) which acts as a guide, taking customers on a tour of
              the website, providing answers, guiding them in their shopping
              decisions, and seamlessly escalating to agent-assisted channels
              when necessary. eGain Virtual Assistant provides the frontline
              support so your customer service staff can concentrate on more
              complex tasks.
            </p>
          </div>
        </div>
        ...
        <div class="md:w-1/3 p-4">
          ...
          <div class="bg-gray-100 border-r-2 border-gray-300 p-4">
            <p class="text-gray-700">
              ...
              the industry’s top-rated customer engagement software suite, which
              helps businesses transform their traditional call centers into
              multichannel customer engagement hubs. Effectively categorize
              interactions Make agents more productive Resolve issues quickly
              Monitor and track every call Integrate multichannel customer
              communications
            </p>
          </div>

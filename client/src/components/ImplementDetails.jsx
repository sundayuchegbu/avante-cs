    ...
    <section className={layout.sectionReverse}>
      <div className={`hidden md:block ${layout.sectionImgReverse}`}>
        ...
        <div className="flex justify-center item-center mt-12">
          ...
          <div className=" absolute top-12 -bottom-6 left-1/2  w-8 bg-background"></div>
          <div className=" absolute top-12 right-[118px]  md:w-60 w-40  md:h-20 h-12 bg-background"></div>
          <div className=" absolute -bottom-6  left-[124px]  md:w-[260px] w-44 sm:h-20 h-12 bg-background"></div>
        </div>
      ...
      <div className={layout.sectionInfo}>
        ...
        >
          <p className=" font-inter font-normal text-dark list-disc leading-[25.8px] md:p-0 p-4 md:mb-4">

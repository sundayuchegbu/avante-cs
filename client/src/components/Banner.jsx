...
const Banner = () => (
  <div className="relative">
    <div className="grid lg:grid-cols-2 gap-0 ">
      <div className="relative">
        <img src={base} alt="base" className="w-full h-[721px] object-cover " />
        <div className="absolute inset-0 bg-primary opacity-75"></div>
        <div className="absolute inset-0 flex items-center  justify-center">
          <div className="text-center text-white px-4  ">
            <h1 className={` ${styles.heading6}  py-8 px-4`}>
              Lorem ipsum dolor
            ...
            <button className="bg-secondary font-inter text-white flex flex-start font-bold py-2 px-8  rounded">
              Read more
            </button>
          </div>
        </div>
      ...
      <img
        src={banner}
        alt="banner"
        className="w-full h-[721px] object-cover"
      />
    </div>
  </div>
);

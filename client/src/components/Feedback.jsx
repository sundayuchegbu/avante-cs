...
const Feedback = () => (
  <div className="md:flex justify-between   md:mx-24 mb-12">
    <div className="md:w-1/3 md:h-[274px] h-[160px] md:w-[350px] w-[329px] p-6 border-2 md:mb-4 mb-12 ml-8 border-primary  rounded-lg">
      ...
      <p className="font-inter font-normal md:text-[14px] text-[12px] ml-4">
    ...
    <div className="md:w-1/3 md:h-[274px] h-[160px] md:w-[350px] w-[329px] p-6 border-2 md:mb-4 mb-12 ml-8 border-primary  rounded-lg">
      ...
      <p className="font-inter font-normal md:text-[14px] text-black2 text-[12px] ml-4">
    ...
    <div className="md:w-1/3 md:h-[274px] h-[160px] md:w-[350px] w-[329px] p-6 border-2 md:mb-4 mb-12 ml-8 border-primary  rounded-lg">
      ...
      <p className="font-inter font-normal text-black2 md:text-[14px] text-[12px] ml-4">

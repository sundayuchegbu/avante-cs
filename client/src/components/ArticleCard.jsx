        ...
        <div>
          ...
          <Link to={`/details/${post.id}`}>
            <div className="">
              ...
              <p className="absolute md:mt-8  font-inter font-normal text-black md:w-[334px] sm:h-[69px] md:text-[14px] text-[10px]  ">
                {post.caption}
              </p>
            </div>
          </Link>
          <div className="block mt-[150px]">
            <Link to={`/details/${post.id}`}>
              <button className="flex md:ml-0 ml-[-53px] items-center block text-[12px]  ">

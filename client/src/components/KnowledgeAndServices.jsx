...
const KnowledgeAndServices = () => {
  return (
    <div className="relative mb-8 mt-24 bg-background">
      ...
      <div className="md:flex mt-12 mb-8 bg-background sm:mx-28">
        <div className="md:flex flex-col sm:w-[543px] w-[350px] sm:h-[329px] h-[350.48px] min-w-[280px] mx-auto border border-l sm:mb-24 ">
          <div className="relative  ">
            ...
            <div className="block h-[16px]  flex items-center sm:pb-44 pb-2  sm:mt-0 mt-[-50px]  sm:w-[543px] w-[366px] sm:h-[329px] h-[310px] ">
              <p className="font-inter font-normal sm:ml-8 leading-[25.8px] xs:text-[14px] text-[12px] text-black1 px-4  md:w-[500px] md:h-[114px] ">
                {" "}
        ...
        <div className="md:flex flex-col  sm:w-[543px] w-[350px] sm:h-[329px] h-[350.48px] sm:mt-0 mt-[50px] min-w-[280px] mx-auto border border-l sm:ml-12  ">
          <div className="relative ">
            <img
              src={egainself}
              alt="egainself"

...
const Projects = () => {
  return (
    <div className="mb-24">
      <div class="grid grid-cols-2 md:grid-cols-2 gap-8 mb-24  p-12 ">
        <div class="relative mb-56 ">
          <img src={mtn1} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4 ">MTN NIGERIA</h2>
            <p className=" font-Inter font-normal text-black2 text-[12px] leading-[20.8px] sm:px-16 px-6  mb-2">
            ...
            <button className="text-secondary ml-[280px]">Read more </button>
            <img
              src={arrow}
              alt="arrow"
              className="-mt-4  ml-[400px] h-[20px]   w-[100px] top-[10px] "
            />{" "}
          </div>
        </div>
        <div class="relative mb-56 ">
          <img src={moloyal} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">MoLoyal</h2>
            <p className=" font-Inter font-normal text-black2 text-[12px] leading-[20.8px] sm:px-16 px-6  mb-2">
        ...
        <div class="relative mb-56 ">
          <img src={tado} alt="tado" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">Tado Emme</h2>
            <p className=" font-Inter font-normal text-black2 text-[12px] leading-[20.8px] sm:px-16 px-6  mb-2">
        ...
        <div class="relative mb-56 ">
          <img src={laswa1} alt="laswa1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={idi} alt="idi" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={driving} alt="driving" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">Decima and Co</h2>
            <p className=" font-Inter font-normal text-black2 text-[12px] leading-[20.8px] sm:px-16 px-6  mb-2">
        ...
        <div class="relative mb-56 ">
          <img src={starkey} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={compass} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={offshore} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">4H Offshore </h2>
            <p className=" font-Inter font-normal text-black2 text-[12px] leading-[20.8px] sm:px-16 px-6  mb-2">
        ...
        <div class="relative mb-56 ">
          <img src={sector} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={legal} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={energy} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
              Silverstream Energy
            </h2>
        ...
        <div class="relative mb-56 ">
          <img src={customer} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
        ...
        <div class="relative mb-56 ">
          <img src={agent} alt="mtn1" class="w-full" />
          <div class="absolute inset-x-0 bottom-0 top-[280px]  bg-white ring-gray-200 shadow-lg  h-[224px]  w-[600px] ml-12 min-w-[470px] ">
            <h2 class="text-lg font-bold mt-4 ml-56 mb-4">
              MoLoyal Agent App{" "}
            </h2>
            ...
            <button className="text-secondary ml-[300px]">Read more </button>
            <img
              src={arrow}
              alt="arrow"
              className="-mt-4  ml-[400px] h-[20px]   w-[100px] top-[10px] "
